...
class PageTitleView: UIView {
    ...
    fileprivate lazy var scrollLine : UIView = {
        ...
        scrollLine.backgroundColor = UIColor(r: UInt32(kSelectColor.0), g: UInt32(kSelectColor.1), b: UInt32(kSelectColor.2))
        return scrollLine
    }()
...
extension PageTitleView {
    ...
    fileprivate func setupTitleLabels(){
        ...
        for (index,title) in titles.enumerated(){
            ...
            label.textColor = UIColor(r: UInt32(kNormalColor.0), g: UInt32(kNormalColor.1), b: UInt32(kNormalColor.2))
    ...
    fileprivate func setupBottomAndLine(){
        ...
        firstLabel.textColor = UIColor(r: UInt32(kSelectColor.0), g: UInt32(kSelectColor.1), b: UInt32(kSelectColor.2))
...
extension PageTitleView {
    @objc fileprivate func titleLabelClick(_ tapGes:UITapGestureRecognizer){
        ...
        currentLabel.textColor = UIColor(r: UInt32(kSelectColor.0), g: UInt32(kSelectColor.1), b: UInt32(kSelectColor.2))
        oldLabel.textColor = UIColor(r: UInt32(kNormalColor.0), g: UInt32(kSelectColor.1), b: UInt32(kSelectColor.2))
...
extension PageTitleView {
    func setTitleWithProgress(_ progress:CGFloat,sourceIndex : Int,targetIndex : Int){
        ...
        sourceLabel.textColor = UIColor(r: UInt32(kSelectColor.0 - colorDelta.0 * progress), g: UInt32(kSelectColor.1 - colorDelta.1 * progress), b: UInt32(kSelectColor.2 - colorDelta.2 * progress))
        targetLabel.textColor = UIColor(r: UInt32(kNormalColor.0 + colorDelta.0 * progress), g: UInt32(kNormalColor.1 + colorDelta.1 * progress), b:UInt32(kNormalColor.2 + colorDelta.2 * progress))
        //
