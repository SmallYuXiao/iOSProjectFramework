...
// Animation Styles
public enum LCAnimationStyle {
    case noAnimation, topToBottom, bottomToTop, leftToRight, rightToLeft
}

// Action Types
public enum LCActionType {
    case none, selector, closure
}

public enum LCAlertButtonLayout {
    case horizontal, vertical
}
// Button sub-class
open class LCButton: UIButton {
    var actionType = LCActionType.none
...
// Example: LCAlertPop().showSuccess(self, title: "Test", subTitle: "Value").close()
open class LCAlertPopResponder {
    let alertview: LCAlertPop
    
    // Initialisation and Title/Subtitle/Close functions
    public init(alertview: LCAlertPop) {
...
let uniqueAccessibilityIdentifier: String = "LCAlertPop"

public typealias DismissBlock = () -> Void

// The Main Class
open class LCAlertPop: UIViewController {
    
    public struct LCAppearance {
        ...
        var shouldAutoDismiss: Bool // Set this false to 'Disable' Auto hideView when LCButton is tapped
        var contentViewCornerRadius : CGFloat
        var fieldCornerRadius : CGFloat
        var buttonCornerRadius : CGFloat
        var dynamicAnimatorActive : Bool
        var buttonsLayout: LCAlertButtonLayout
    ...
    public struct LCTimeoutConfiguration {
    ...
    var timeout: LCTimeoutConfiguration?
    var showTimeoutTimer: Timer?
    var timeoutTimer: Timer?
    var dismissBlock : DismissBlock?
    fileprivate var inputs = [UITextField]()
    fileprivate var input = [UITextView]()
    internal var buttons = [LCButton]()
    fileprivate var selfReference: LCAlertPop?
    
    public init(appearance: LCAppearance) {
    ...
    fileprivate func setup() {
        ...
        if appearance.disableTapGesture == false {
            let tapGesture = UITapGestureRecognizer(target: self, action: #selector(LCAlertPop.tapped(_:)))
    ...
    override open func viewWillLayoutSubviews() {
        ...
        if let title = labelTitle.text {
            titleActualHeight = title.lc_heightWithConstrainedWidth(width: appearance.kWindowWidth - hMargin * 2, font: labelTitle.font) + 10
    ...
    override open func viewDidAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(LCAlertPop.keyboardWillShow(_:)), name:NSNotification.Name.UIKeyboardWillShow, object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(LCAlertPop.keyboardWillHide(_:)), name:NSNotification.Name.UIKeyboardWillHide, object: nil);
    }
    ...
    @discardableResult
    open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showTimeout:LCButton.ShowTimeoutConfiguration? = nil, action:@escaping ()->Void)->LCButton {
        let btn = addButton(title, backgroundColor: backgroundColor, textColor: textColor, showTimeout: showTimeout)
        btn.actionType = LCActionType.closure
        btn.action = action
        btn.addTarget(self, action:#selector(LCAlertPop.buttonTapped(_:)), for:.touchUpInside)
        btn.addTarget(self, action:#selector(LCAlertPop.buttonTapDown(_:)), for:[.touchDown, .touchDragEnter])
        btn.addTarget(self, action:#selector(LCAlertPop.buttonRelease(_:)), for:[.touchUpInside, .touchUpOutside, .touchCancel, .touchDragOutside] )
        return btn
    }
    
    @discardableResult
    open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showTimeout:LCButton.ShowTimeoutConfiguration? = nil, target:AnyObject, selector:Selector)->LCButton {
        let btn = addButton(title, backgroundColor: backgroundColor, textColor: textColor, showTimeout: showTimeout)
        btn.actionType = LCActionType.selector
        btn.target = target
    ...
    @discardableResult
    fileprivate func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showTimeout:LCButton.ShowTimeoutConfiguration? = nil)->LCButton {
        // Update view height
    ...
    @objc func buttonTapped(_ btn:LCButton) {
        if btn.actionType == LCActionType.closure {
            btn.action()
        } else if btn.actionType == LCActionType.selector {
            let ctrl = UIControl()
    ...
    @objc func buttonTapDown(_ btn:LCButton) {
        var hue : CGFloat = 0
    ...
    @objc func buttonRelease(_ btn:LCButton) {
    ...
    //Dismiss keyboard when tapped outside textfield & close LCAlertPop when hideWhenBackgroundViewIsTapped
    ...
    @discardableResult
    open func showCustom(_ title: String, subTitle: String, color: UIColor, icon: UIImage, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertPopStyle.success.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertPopResponder {
    ...
    @discardableResult
    open func showSuccess(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertPopStyle.success.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertPopResponder {
    ...
    @discardableResult
    open func showError(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertPopStyle.error.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertPopResponder {
    ...
    @discardableResult
    open func showNotice(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertPopStyle.notice.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertPopResponder {
    ...
    @discardableResult
    open func showWarning(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertPopStyle.warning.defaultColorInt, colorTextButton: UInt=0x000000, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertPopResponder {
    ...
    @discardableResult
    open func showInfo(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertPopStyle.info.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertPopResponder {
    ...
    @discardableResult
    open func showWait(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt?=LCAlertPopStyle.wait.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertPopResponder {
    ...
    @discardableResult
    open func showEdit(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertPopStyle.edit.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertPopResponder {
    ...
    @discardableResult
    open func showTitle(_ title: String, subTitle: String, style: LCAlertPopStyle, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt?=0x000000, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertPopResponder {
    ...
    @discardableResult
    open func showTitle(_ title: String, subTitle: String, timeout: LCTimeoutConfiguration?, completeText: String?, style: LCAlertPopStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertPopResponder {
        selfReference = self
        view.alpha = 0
        view.tag = uniqueTag
        ...
        case .success:
            ...
            iconImage = checkCircleIconImage(circleIconImage, defaultImage: LCAlertPopStyleKit.imageOfCheckmark)
            
        case .error:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage: LCAlertPopStyleKit.imageOfCross)
            
        case .notice:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:LCAlertPopStyleKit.imageOfNotice)
            
        case .warning:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:LCAlertPopStyleKit.imageOfWarning)
            
        case .info:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:LCAlertPopStyleKit.imageOfInfo)
            
        case .edit:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:LCAlertPopStyleKit.imageOfEdit)
            
        case .wait:
            iconImage = nil
            
        case .question:
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:LCAlertPopStyleKit.imageOfQuestion)
        }
        
        // Title
        if !title.isEmpty {
            self.labelTitle.text = title
            let actualHeight = title.lc_heightWithConstrainedWidth(width: appearance.kWindowWidth - 24, font: self.labelTitle.font)
        ...
        if appearance.showCloseButton {
            _ = addButton(completeText ?? "取消", target:self, selector:#selector(LCAlertPop.hideView))
        }
        ...
        if let timeout = timeout {
            ...
            timeoutTimer = Timer.scheduledTimer(timeInterval: timeout.value, target: self, selector: #selector(LCAlertPop.hideViewTimeout), userInfo: nil, repeats: false)
            showTimeoutTimer?.invalidate()
            showTimeoutTimer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(LCAlertPop.updateShowTimeout), userInfo: nil, repeats: true)
        }
        ...
        // Chainable objects
        return LCAlertPopResponder(alertview: self)
    }
    
    // Show animation in the alert view
    fileprivate func showAnimation(_ animationStyle: LCAnimationStyle = .topToBottom, animationStartOffset: CGFloat = -400.0, boundingAnimationOffset: CGFloat = 15.0, animationDuration: TimeInterval = 0.2) {
    ...
    @objc open func hideView() {
        UIView.animate(withDuration: 0.2, animations: {
            ...
            // This is necessary for LCAlertPop to be de-initialized, preventing a strong reference cycle with the viewcontroller calling LCAlertPop.
    ...
    //Return true if a LCAlertPop is already being shown, false otherwise
...
class LCAlertPopStyleKit : NSObject {
    ...
    class var imageOfCheckmark: UIImage {
        ...
        LCAlertPopStyleKit.drawCheckmark()
    ...
    class var imageOfWarning: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        LCAlertPopStyleKit.drawWarning()
    ...
    class var imageOfQuestion: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        LCAlertPopStyleKit.drawQuestion()
